...
var NodeCache = /*#__PURE__*/_createClass(function NodeCache(key, value) {
...
var TYPE_WEBGL_IMAGE = 2;
var TYPE_WEBGL_BACKGROUND_SIZE = 3;

var StyleApplyCache = /*#__PURE__*/function () {
  function StyleApplyCache() {
    _classCallCheck(this, StyleApplyCache);
  ...
  _createClass(StyleApplyCache, [{
    ...
    key: "addTransitionItem",
    value: function addTransitionItem(css_rule, transition_duration) {
      this.clearTimeout();
      this.cache.push([TYPE_TRANSITION, css_rule, transition_duration]);
      this.setTimeout(1000);
    }
  }, {
    key: "addWebGlImageItem",
    value: function addWebGlImageItem(css_rule, response, priority) {
      this.clearTimeout();
      this.cache.push([TYPE_WEBGL_IMAGE, css_rule, response, priority]);
      this.setTimeout(500);
    }
  }, {
    key: "addWebGlBackgroundSizeItem",
    value: function addWebGlBackgroundSizeItem(css_rule, imageBackgroundSize, imageBackgroundSizePriority) {
      this.clearTimeout();
...
var Core = /*#__PURE__*/function () {
  ...
  _createClass(Core, [{
    ...
    key: "startConverting",
    value: function startConverting() {
      var _this2 = this;

      setTimeout(function () {
        //on next iteration of event loop to prevent some site error stops our script
        // if (this.mode === Mode.DARK) {
        _this2.addDefaultCSS();

        _this2.state.initAndShowLoading(true);

        _this2.styleConverter.init();

        _this2.styleConverter.convert();

        _this2.mutationManager.init(); //}

      }, 0);
    }
  }, {
    key: "reinitDomElements",
    value: function reinitDomElements() {
...
var MutationManager = /*#__PURE__*/function () {
  ...
  _createClass(MutationManager, [{
    ...
    key: "process",
    value: function process(mutations) {
    ...
    key: "onNodesRemoved",
    value: function onNodesRemoved(child_list) {
    ...
    key: "onNodesAdded",
    value: function onNodesAdded(child_list) {
      for (var i = child_list.length; i-- > 0;) {
        var node = child_list[i];
      ...
      switch (node.tagName) {
        ...
        case 'LINK':
          ...
          node.addEventListener('load', function () {
            ...
            _this3.styleConverter.convertStyleSheetFromMutator(node.sheet, false, needDownload);
          });
    ...
    value: function onAttributeChange(mutation) {
    ...
    key: "reinitContentScripts",
    value: function reinitContentScripts() {
...
var State = /*#__PURE__*/function () {
  ...
  _createClass(State, [{
    key: "initAndShowLoading",
    value: function initAndShowLoading(isDarkMode) {
      var _this = this;
    ...
    key: "onReady",
    value: function onReady(isDarkMode) {
      if (this.isReady) {
        return;
      }
    ...
    key: "checkDocumentState",
    value: function checkDocumentState(isDarkMode) {
      var _this2 = this;
      ...
      var bodyTimer = setInterval(function () {
        ...
        _this2.checkCSSParsedFinished(isDarkMode);

        var timer = setInterval(function () {
          // console.log("LOOP");
          if (_this2.checkCSSParsedFinished(isDarkMode) || ++_this2.emergencyCheckCounter >= 70) {
            //7 seconds
            clearInterval(timer);
          }
        }, 100);
    ...
    key: "checkCSSParsedFinished",
    value: function checkCSSParsedFinished(isDarkMode) {
...
var StyleConverter = /*#__PURE__*/function () {
  function StyleConverter(local_settings) {
  ...
  _createClass(StyleConverter, [{
    ...
    value: function convert() {
      ...
      var timer1 = setInterval(function () {
        _this.convertProcedure();

        if (document.readyState === 'complete') {
          clearInterval(timer1);

          _this.checkForDynamicChanges();

          if (_constants_constants__WEBPACK_IMPORTED_MODULE_0__.S.URL === 'bugs.chromium.org') {
            // Dom Shadow website
            _this.checkAndConvertDomShadowElements(document.body);
    ...
    key: "checkForDynamicChanges",
    value: function checkForDynamicChanges() {
      var _this2 = this;
      ...
      setInterval(function () {
        _this2.convertStyleNodes(false);
      }, 1000);
    }
  }, {
    key: "convertProcedure",
    value: function convertProcedure(isReInit) {
    ...
    key: "convertStyleNodes",
    value: function convertStyleNodes(isReInit) {
    ...
    key: "convertStyleSheetFromMutator",
    value: function convertStyleSheetFromMutator(style_sheet, forced, download) {
    ...
    key: "convertIFrames",
    value: function convertIFrames() {
      var iframes_n = document.querySelectorAll('iframe:not([src])');

      for (var i = iframes_n.length; i-- > 0;) {
        this.convertIFrame(iframes_n[i]);
      }

      iframes_n = document.querySelectorAll('iframe[src^="javascript"]');

      for (var j = iframes_n.length; j-- > 0;) {
        this.convertIFrame(iframes_n[j]);
      }
    }
  }, {
    key: "convertStyleSheets",
    value: function convertStyleSheets(sheets) {
      for (var j = sheets.length; j-- > 0;) {
        this.convertStyleSheet(sheets[j], false);
      }
    }
  }, {
    key: "convertLinkImports",
    value: function convertLinkImports() {
    ...
    key: "addEventListenerLinkImportNode",
    value: function addEventListenerLinkImportNode(node) {
      var _this3 = this;

      node.addEventListener('load', function () {
        _this3.convertStyleSheets(node.import.styleSheets);
      });
    }
  }, {
    key: "convertInlineStyles",
    value: function convertInlineStyles() {
      var nodes = document.querySelectorAll('[style],[fill],[stroke],[bgcolor]');

      for (var i = nodes.length; i-- > 0;) {
        this.convertInlineStyle(nodes[i]);
      }
    }
  }, {
    key: "convertImgNodes",
    value: function convertImgNodes() {
      var nodes = document.querySelectorAll('img');

      for (var i = nodes.length; i-- > 0;) {
        this.convertImgNode(nodes[i]);
      }
    }
  }, {
    key: "convertStyleSheet",
    value: function convertStyleSheet(style_sheet, forced) {
      var owner_node = style_sheet.ownerNode;
    ...
    key: "convertInlineStyle",
    value: function convertInlineStyle(node) {
      if (typeof node.getAttribute === 'undefined') return;
      ...
      for (var j = foreground_attributes.length; j-- > 0;) {
        node.removeAttribute(foreground_attributes[j]);
      }
    ...
    key: "convertImgNode",
    value: function convertImgNode(node) {//To do: convert svg image in src tag
    }
  }, {
    key: "convertIFrame",
    value: function convertIFrame(node) {
    ...
    key: "downloadCSS",
    value: function downloadCSS(href, owner_node, media, importCSSIndex) {
      var _this4 = this;

      if (href === '') return;
      ++_constants_constants__WEBPACK_IMPORTED_MODULE_0__.S.isInitialConvertedCounter;
      href = _utilities_utilities__WEBPACK_IMPORTED_MODULE_1__/* ["default"].makeURL */ .Z.makeURL(href);
      this.executeDownloadCSS(href).then(function (data) {
        _this4.processResponseDownloadCSS(data, owner_node, media, href, importCSSIndex);
    ...
    key: "executeDownloadCSS",
    value: function executeDownloadCSS(href) {
      return new Promise(function (resolve, reject) {
        var ajax = new XMLHttpRequest();
        ajax.open('get', href, true);

        ajax.onerror = function (errorV, errorV1) {
          //ajax.status = 0
          //ajax.readyState = 4
          reject();
          console.clear();
    ...
    key: "processResponseDownloadCSS",
    value: function processResponseDownloadCSS(responseText, owner_node, media, href, importCSSIndex) {
      var _this5 = this;
      ...
      setTimeout(function () {
        //because of firefox
        _this5.convertStyleSheet(style_n.sheet, false);
      }, 0);
      --_constants_constants__WEBPACK_IMPORTED_MODULE_0__.S.isInitialConvertedCounter;
    }
  }, {
    key: "duplicateAndParseStyleElement",
    value: function duplicateAndParseStyleElement(owner_node, media, css_rules) {
      var _this6 = this;
      ...
      setTimeout(function () {
        //because of firefox
        _this6.convertStyleSheet(style_n.sheet, false);
      }, 0);
    }
  }, {
    key: "checkAndParseImportURL",
    value: function checkAndParseImportURL(css_import_rule) {
    ...
    key: "convertImportUrls",
    value: function convertImportUrls(styles, isRemovingImports) {
      var result = '';
    ...
    key: "convertRelativeUrlsToAbsolute",
    value: function convertRelativeUrlsToAbsolute(styles, url) {
      var result = '';
    ...
    key: "convertURLs",
    value: function convertURLs(styles, parentHref, checkForImportUrls) {
      ...
      for (var _start = 0;;) {
        var url_start_index = styles.indexOf('url(', _start);

        if (url_start_index === -1) {
          result += styles.substring(_start);
          break;
        }
        ...
        ++url_end_index;
        result += styles.substring(_start, url_start_index);
        _start = url_end_index;
    ...
    key: "addStyleNodeWithCSSText",
    value: function addStyleNodeWithCSSText(href, css_text, owner_node, media, importCSSIndex) {
      var style_n = document.createElement('style');
    ...
    key: "processCSSRules",
    value: function processCSSRules(css_rules, owner_node) {
    ...
    key: "parseCSSRule",
    value: function parseCSSRule(css_rule, foreground_properties, background_properties) {
      var trasition_duration = css_rule.style.transitionDuration;
      var control_duration = trasition_duration !== '';
    ...
    key: "parseCSSVariables",
    value: function parseCSSVariables(css_rule) {
    ...
    key: "extractCSSVariable",
    value: function extractCSSVariable(css_rule, variable_name) {
      var value;
    ...
    key: "parseCSSVariable",
    value: function parseCSSVariable(content, cssRule) {
      var result = '';
    ...
    key: "markCSSVariable",
    value: function markCSSVariable(content, cssRule, converter, isBackgroundParsing) {
      var result = '';
      var startPattern = 'var(';
      ...
      for (var start = 0;;) {
        ...
        start = varEndIndex;
        var startIndexVar = varStartIndex + startOffset;
        var endIndexVar = endIndexPattern;
        ...
        if (alternativeEndIndex !== -1) {
          if (varEndIndex > alternativeEndIndex) {
            ...
            if (defaultValue.indexOf('var(--') === -1) {
              ...
              var convertDefaultValue = converter(defaultValue);

              if (defaultValues.length === 3) {
                // => RGB - 255,255,255. This works only for rgb - https://app.slack.com
                var HSL_values = convertDefaultValue.substring(5, convertDefaultValue.length - 1).split(','); //hsla( === 5 symbols

                var parsedHSLValues = [];

                for (var t = 0; t < HSL_values.length; ++t) {
                ...
                var RGB_values = parsedHSLValues;
    ...
    key: "extractStyles",
    value: function extractStyles(css_text) {
      var result = new Map();

      if (css_text !== undefined) {
        var start = css_text.indexOf('{');
        var end = css_text.indexOf('}');

        if (start !== -1 && end !== -1) {
          css_text = css_text.substring(start + 1, end);
          var rules = css_text.split(';');
    ...
    key: "parse",
    value: function parse(css_rule, properties, convert, cache) {
      var _this7 = this;
      ...
      for (var value, i = properties.length; i-- > 0;) {
      ...
      filtered_properties.forEach(function (value, property) {
        cached_key = value;
        if (value === '') return;
        ...
        if (cached !== -1) {
          _this7.applyNewColor(css_rule, property, cached, priority, true);
        ...
        if (startVariableIndex !== -1) {
          ...
          var valueWithDarkBG = _this7.markCSSVariable(value, css_rule, convert, isBackgroundParsing);

          if (_this7.applyNewColor(css_rule, property, valueWithDarkBG, priority, false)) {
        ...
        if (isBackgroundParsing) {
          if (value.indexOf('url') !== -1) {
            ...
            value = _this7.convertURLs(value, hrefLocation, false);

            _this7.applyNewColor(css_rule, property, value, priority, false);
            ...
            if (_constants_constants__WEBPACK_IMPORTED_MODULE_0__.S.IFRAME === false && _constants_constants__WEBPACK_IMPORTED_MODULE_0__.S.IMAGE_PROCESSING_ENABLED === true) {
              if (value.indexOf('svg') === -1) {
                ...
                var isRepeated = css_rule.style.background.indexOf('repeat') > -1 && css_rule.style.backgroundRepeat.indexOf('repeat') > -1;
                var imageBackgroundSize = null;
                var imageBackgroundSizePriority = ''; // if (window.image_processing_started === undefined)
                ...
                _webgl_processor__WEBPACK_IMPORTED_MODULE_3__/* ["default"].processBackgroundCSSString */ .Z.processBackgroundCSSString({
                  ...
                  if (response.css_text !== null) {
                    ...
                    if (is_node) {
                      ...
                      _this7.style_apply_cache.addWebGlImageItem(css_rule, response, priority); // css_rule.style.setProperty(response.property, response.css_text, priority); //SLOW
                  ...
                  if (imageBackgroundSize !== null) {
                    ...
                    _this7.style_apply_cache.addWebGlBackgroundSizeItem(css_rule, imageBackgroundSize, imageBackgroundSizePriority); // css_rule.style.setProperty('background-size', imageBackgroundSize, imageBackgroundSizePriority); //SLOW
            ...
            if (_this7.applyNewColor(css_rule, property, value, priority, false)) {
    ...
    key: "applyNewColor",
    value: function applyNewColor(css_rule, property, value, priority, force) {
    ...
    key: "isCSSRuleBodyOrHTML",
    value: function isCSSRuleBodyOrHTML(css_rule) {
    ...
    key: "checkAndConvertDomShadowElements",
    value: function checkAndConvertDomShadowElements(parentNode) {
...
var WebGLProcessor = /*#__PURE__*/function () {
  function WebGLProcessor() {
    _classCallCheck(this, WebGLProcessor);
  }

  _createClass(WebGLProcessor, null, [{
    key: "processBackgroundCSSString",
    value: function processBackgroundCSSString(data, callback, hide_callback) {
      var start_index = 0;
      var css = data.value;
      ...
      for (;;) {
        ...
        if (url.slice(0, 10) !== 'data:image') {
          var question_mark_index = url.lastIndexOf('?');
          ...
          var blob_url = this.images_cache.get(url);

          if (blob_url !== undefined) {
            var result = blob_url !== null ? css.replace(replace_url, blob_url) : null;
            callback({
              'css_text': result,
              'property': data.property
            });
...
var QueueStruct = /*#__PURE__*/_createClass(function QueueStruct(css_, url_, replace_url_, property_, callback_) {
  _classCallCheck(this, QueueStruct);
...
var NightEyeWebGLContext = /*#__PURE__*/function () {
  function NightEyeWebGLContext() {
    _classCallCheck(this, NightEyeWebGLContext);
  ...
  _createClass(NightEyeWebGLContext, [{
    key: "init",
    value: function init() {
      ...
      var vert_shader = this.gl.createShader(this.gl.VERTEX_SHADER);
      ...
      var coord = this.gl.getAttribLocation(shader_program, 'a_coordinates');
      this.gl.vertexAttribPointer(coord, 3, this.gl.FLOAT, false, 0, 0);
      this.gl.enableVertexAttribArray(coord);
      var tex_buffer = this.gl.createBuffer();
      ...
      var tex_coord = this.gl.getAttribLocation(shader_program, 'a_texcoord');
      ...
      var textur_location = this.gl.getUniformLocation(shader_program, 'u_texture');
    ...
    value: function process(queue_struct) {
      ...
      fetch(request, options).then(function (response) {
        response.arrayBuffer().then(function (buffer) {
          ...
          img.onerror = _this.onError.bind(_this);
          img.onload = _this.onLoad.bind(_this, img);
          img.src = base64Flag + imageStr;
          if (debug === true) console.log('request', _this.state_url, WebGLProcessor.images_cache.get(_this.state_url));
        });
      });
    }
  }, {
    ...
    value: function onLoad(img) {
      ...
      if (WebGLProcessor.EDGE === true) {
        ...
        c_img.onload = function () {
          _this2.small_canvas_ctx.drawImage(c_img, 0, 0);

          _this2.avg_pixel = _this2.small_canvas_ctx.getImageData(0, 0, WebGLProcessor.AVERAGE_TEXTURE_SIZE, WebGLProcessor.AVERAGE_TEXTURE_SIZE).data;

          _this2.onAverageFound(img);
        };
    ...
    key: "onAverageFound",
    value: function onAverageFound(img) {
      ...
      if (this.avg_pixel[3] < 90) {
        ...
        this.gl.clear(this.gl.COLOR_BUFFER_BIT | this.gl.DEPTH_BUFFER_BIT);
        this.gl.bindTexture(this.gl.TEXTURE_2D, this.gl_texture_real);
        var gray = Math.abs(this.avg_pixel[0] - this.avg_pixel[1]) < 2 && Math.abs(this.avg_pixel[0] - this.avg_pixel[2]) < 2 && Math.abs(this.avg_pixel[1] - this.avg_pixel[2]) < 2;
        var quite_light = this.avg_pixel[0] > 235 && this.avg_pixel[1] > 235 && this.avg_pixel[2] > 235;

        if (gray === false && quite_light === false) {
          //Dim
          var avg_pixel = (this.avg_pixel[0] + this.avg_pixel[1] + this.avg_pixel[2]) / 3;
          var dim = avg_pixel < 210 ? 0.8 : 0.0004074074 * avg_pixel * avg_pixel - 0.2040556 * avg_pixel + 25.63093;
    ...
    key: "onBlobReady",
    value: function onBlobReady(blob) {
      var blob_url = URL.createObjectURL(blob);
      this.onResult(blob_url);
    }
  }, {
    key: "onBase64URL",
    value: function onBase64URL() {
      var base64 = this.canvas.toDataURL();
      this.onResult(base64);
    }
  }, {
    key: "onResult",
    value: function onResult(blob_url) {
    ...
    key: "finish",
    value: function finish(blob_url) {
      var result = blob_url !== null ? this.state_struct.css.replace(this.state_struct.replace_url, blob_url) : null;
  ...
  return NightEyeWebGLContext;
}();

NightEyeWebGLContext.gbp = function (n) {
  var m = n;
  m = m | m >> 1;
  m = m | m >> 2;
  m = m | m >> 4;
...
if (!HTMLCanvasElement.prototype.toBlob) {
  Object.defineProperty(HTMLCanvasElement.prototype, 'toBlob', {
    value: function value(callback) {
      ...
      var binary = atob(base64.substring(base64.indexOf(',') + 1));
...
var ColorMapProcessor = /*#__PURE__*/function () {
  function ColorMapProcessor() {
    _classCallCheck(this, ColorMapProcessor);
  }

  _createClass(ColorMapProcessor, null, [{
    key: "lowerBound",
    value: function lowerBound(source, target) {
      var result = -1;
      var l = 0;
    ...
    value: function getColorIndex(rgb) {
      var indices = ColorMapProcessor.colorKeys.map(function (k, i) {
        return ColorMapProcessor.lowerBound(k, rgb[i]);
      });

      for (var i = indices.length; i-- > 0;) {
        var index = indices[i];
        var currentOffset = ColorMapProcessor.colorKeys[i][index] - rgb[i];
        var previousOffset = rgb[i] - ColorMapProcessor.colorKeys[i][index - 1];
      ...
      var keys = indices.map(function (k, i) {
    ...
    key: "getCustomColor",
    value: function getCustomColor(colorsHSL, customColors) {
      var colors = _toConsumableArray(colorsHSL);

      _color__WEBPACK_IMPORTED_MODULE_0__/* ["default"].HSLtoRGB */ .Z.HSLtoRGB(colors);
      var rgb = [colors[0], colors[1], colors[2]];
      var mainColorIndexLabel = ColorMapProcessor.getColorIndex(rgb);
      var newColorValue = customColors[mainColorIndexLabel];
...
var ColorProcessorUtilities = /*#__PURE__*/function () {
  function ColorProcessorUtilities() {
    _classCallCheck(this, ColorProcessorUtilities);
  }

  _createClass(ColorProcessorUtilities, null, [{
    key: "processBackgroundHSLColorArray",
    value: function processBackgroundHSLColorArray(colors) {
      var success = false;
    ...
    key: "processForegroundHSLColorArray",
    value: function processForegroundHSLColorArray(colors) {
      var success = false;
    ...
    key: "makeHSLAString",
    value: function makeHSLAString(colors) {
      return 'hsla(' + colors[0] + ',' + colors[1] + '%,' + colors[2] + '%,' + colors[3] + ')';
    }
  }, {
    key: "getLightValueBasedOnDarkTheme",
    value: function getLightValueBasedOnDarkTheme() {
  ...
  return ColorProcessorUtilities;
}();
...
var ColorProcessor = /*#__PURE__*/function () {
  function ColorProcessor() {
    _classCallCheck(this, ColorProcessor);
  ...
  _createClass(ColorProcessor, [{
    key: "convertBackgroundColorString",
    value: function convertBackgroundColorString(style_string) {
      return this.convertColorString(style_string, this.mode_background);
    }
  }, {
    key: "convertForegroundColorString",
    value: function convertForegroundColorString(style_string) {
      return this.convertColorString(style_string, this.mode_foreground);
    }
  }, {
    key: "convertColorString",
    value: function convertColorString(style_string, mode) {
    ...
    key: "convertHEX",
    value: function convertHEX(style_string, i, mode) {
      var valid, c, j;
      ...
      if (i + 6 < style_string.length) {
        ...
        if (j >= 4) {
          ...
          var _colors = [parseInt(style_string[i + 1] + style_string[i + 1], 16), parseInt(style_string[i + 2] + style_string[i + 2], 16), parseInt(style_string[i + 3] + style_string[i + 3], 16), 1]; //if (mode.isApplicable(colors)) {

          this.out.style_string = mode.applyToRGBColorsAsString(_colors);
      ...
      if (i + 3 < style_string.length) {
        ...
        if (valid) {
          var _colors2 = [parseInt(style_string[i + 1] + style_string[i + 1], 16), parseInt(style_string[i + 2] + style_string[i + 2], 16), parseInt(style_string[i + 3] + style_string[i + 3], 16), 1]; //if (mode.isApplicable(colors)) {

          this.out.style_string = mode.applyToRGBColorsAsString(_colors2);
          this.out.jump_size = 3; //}
    ...
    key: "convertRGB",
    value: function convertRGB(style_string, i, mode) {
    ...
    key: "convertName",
    value: function convertName(style_string, i, mode) {
      var j,
          match = null,
      ...
      for (j = i; j < style_string.length; ++j) {
        var map = parent_map[style_string[j]];
    ...
    key: "parseColorsToHSL",
    value: function parseColorsToHSL(style_string, i) {
      this.out.jump_size = 0;
...
var Color = /*#__PURE__*/function () {
  ...
  _createClass(Color, null, [{
    key: "makeHSLColorString",
    value: function makeHSLColorString(colors) {
      return 'hsl(' + colors[0] + ',' + colors[1] + '%,' + colors[2] + '%)';
    }
  }, {
    key: "makeColorKeyFromArray",
    value: function makeColorKeyFromArray(colors) {
      return colors[0] << 16 | colors[1] << 8 | colors[2];
    }
  }, {
    key: "makeHSLColorArrayFromKey",
    value: function makeHSLColorArrayFromKey(color_key) {
      return [color_key >> 16 & 0xFF, color_key >> 8 & 0xFF, color_key & 0xFF];
    }
  }, {
    key: "RGBtoHSL",
    value: function RGBtoHSL(colors) {
      var r = colors[0] / 255;
      var g = colors[1] / 255;
      var b = colors[2] / 255;
      var hue, sat, light;
    ...
    key: "HSLtoRGB",
    value: function HSLtoRGB(colors) {
      colors[0] %= 360;
      var S = colors[1] * 0.01;
      var L = colors[2] * 0.01;
    ...
    key: "modFloat",
    value: function modFloat(v, base) {
      var a = v / base;
      a -= Math.floor(a);
      return a * base;
    }
...
var ModeBackground = /*#__PURE__*/function () {
  function ModeBackground(colorProcessor) {
    _classCallCheck(this, ModeBackground);

    this.initial = [0, 0, 0, 0];
    this.colorProcessor = colorProcessor;
  }

  _createClass(ModeBackground, [{
    key: "applyToHSLColorsAsString",
    value: function applyToHSLColorsAsString(colors) {
      ...
      if (window.nightEyeProOptions !== undefined) {
        var newColorValue = _color_map_processor__WEBPACK_IMPORTED_MODULE_2__/* ["default"].getCustomColor */ .Z.getCustomColor(colors, window.nightEyeProOptions.colorsBackground);
    ...
    key: "applyToRGBColorsAsString",
    value: function applyToRGBColorsAsString(colors) {
...
var ModeForeground = /*#__PURE__*/function () {
  function ModeForeground(colorProcessor) {
    _classCallCheck(this, ModeForeground);

    this.initial = [0, 0, 0, 1];
    this.colorProcessor = colorProcessor;
  }

  _createClass(ModeForeground, [{
    key: "applyToHSLColorsAsString",
    value: function applyToHSLColorsAsString(colors) {
      ...
      if (window.nightEyeProOptions !== undefined) {
        var newColorValue = _color_map_processor__WEBPACK_IMPORTED_MODULE_2__/* ["default"].getCustomColor */ .Z.getCustomColor(colors, window.nightEyeProOptions.colorsForeground);
...
var Utilities = /*#__PURE__*/function () {
  ...
  _createClass(Utilities, null, [{
    key: "makeURL",
    value: function makeURL(url, PAGE_PROTOCOL, PAGE_HOSTNAME, PAGE_PORT, PAGE_URL) {
    ...
    key: "insertAfter",
    value: function insertAfter(new_node, ref_node) {
    ...
    key: "insertBefore",
    value: function insertBefore(new_node, ref_node) {
      ref_node.parentNode.insertBefore(new_node, ref_node);
    }
  }, {
    key: "makeParsedStyleNode",
    value: function makeParsedStyleNode() {
      var style_n = document.createElement('style');
    ...
    key: "makeParsedLinkNode",
    value: function makeParsedLinkNode(href) {
...
var NightEyeStart = /*#__PURE__*/function () {
  function NightEyeStart(options) {
    _classCallCheck(this, NightEyeStart);

    this.options = options;
    this.isDarkMode = false;
  }

  _createClass(NightEyeStart, [{
    key: "init",
    value: function init() {
...
var Widget = /*#__PURE__*/function () {
  function Widget(isDarkMode, options) {
  ...
  _createClass(Widget, [{
    ...
    value: function show() {
      ...
      this.iconButton.addEventListener('click', function () {
        _this.showDialog();
      });
    ...
    value: function showDialog() {
      ...
      this.dialogBackground.addEventListener('click', function () {
        _this2.closeDialog();
      });
      ...
      input.addEventListener('change', function () {
        ...
        _this2.UI_addClass(loading, 'NightEyeActive NightEyeMode-' + mode);

        setTimeout(function () {
          _this2.changeMode(mode);
        }, 0);
      }); //===========================================
    ...
    key: "UI_addClass",
    value: function UI_addClass(el, className) {
      el.className += ' ' + className;
    }
  }, {
    key: "UI_removeClass",
    value: function UI_removeClass(el, className) {
      var newClassName = "";
      var i;
...
var Cookies = /*#__PURE__*/function () {
  ...
  _createClass(Cookies, null, [{
    ...
    key: "getValue",
    value: function getValue(cookie_name) {
      var cookie,
...
var Utilities = /*#__PURE__*/function () {
  ...
  _createClass(Utilities, null, [{
    ...
    key: "isInTimerInterval",
    value: function isInTimerInterval(startHourData, endHourData) {
