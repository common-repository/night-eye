...
var OptionsPage = /*#__PURE__*/function () {
  ...
  _createClass(OptionsPage, [{
    ...
    key: "createBox",
    value: function createBox(parent, name) {
    ...
    value: function renderLicenseKey(parent) {
    ...
    value: function renderRestrictions(parent) {
      var row = document.createElement('div');
      parent.appendChild(row);
      row.className = 'Row';
      var label = document.createElement('div');
    ...
    key: "renderPoweredByNightEye",
    value: function renderPoweredByNightEye(parent) {
      var row = document.createElement('div');
      parent.appendChild(row);
      row.className = 'Row';
      var label = document.createElement('div');
    ...
    key: "renderProVersionContent",
    value: function renderProVersionContent(parent) {
      var value = document.createElement('div');
      ...
      var useFremiumButton = document.createElement('a');
    ...
    key: "renderStatusSettings",
    value: function renderStatusSettings(parent) {
      var row = document.createElement('div');
      parent.appendChild(row);
      row.className = 'Row';
      var label = document.createElement('div');
      ...
      for (var i = 0; i < _constants_SV__WEBPACK_IMPORTED_MODULE_1__/* ["default"].PluginStatus.length */ .Z.PluginStatus.length; ++i) {
        var statusItem = _constants_SV__WEBPACK_IMPORTED_MODULE_1__/* ["default"].PluginStatus */ .Z.PluginStatus[i];
    ...
    key: "renderDesktopPositionSettings",
    value: function renderDesktopPositionSettings(parent) {
      var row = document.createElement('div');
      parent.appendChild(row);
      row.className = 'Row';
      var label = document.createElement('div');
      ...
      for (var i = 0; i < _constants_SV__WEBPACK_IMPORTED_MODULE_1__/* ["default"].WidgetPositions.length */ .Z.WidgetPositions.length; ++i) {
        var positionItem = _constants_SV__WEBPACK_IMPORTED_MODULE_1__/* ["default"].WidgetPositions */ .Z.WidgetPositions[i];
        var option = document.createElement('option');
        select.appendChild(option);
    ...
    key: "renderMobilePositionSettings",
    value: function renderMobilePositionSettings(parent, options) {
      var row = document.createElement('div');
      parent.appendChild(row);
      row.className = 'Row';
      var label = document.createElement('div');
    ...
    value: function renderSubmitButton(parent) {
      var _this = this;
      ...
      var moreOptionButton = document.createElement('a');
    ...
    value: function updatePage() {
      ...
      var controller = NightEyeConfig.generalController + '/updateOptions';
      var ajax = new _utilities_Ajax__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z();
    ...
    key: "isTimerActivate",
    value: function isTimerActivate() {
    ...
    key: "collectAllInputValues",
    value: function collectAllInputValues() {
      var inputs = this.pageContent.querySelectorAll('input, textarea, select');
...
var Ajax = /*#__PURE__*/function () {
  ...
  _createClass(Ajax, [{
    key: "open",
    value: function open(method_, url_, async_) {
      this.method = method_;
      this.url = url_;
    ...
    key: "setResponseType",
    value: function setResponseType(response_type) {
    ...
    value: function onProgressListener(e) {
...
var Header = /*#__PURE__*/_createClass(function Header(name_, value_) {
